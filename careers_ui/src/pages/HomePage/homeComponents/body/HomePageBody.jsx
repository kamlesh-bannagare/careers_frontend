...
function ExpandableDescription({ text, onClick }) {
  ...
  return (
    <Typography onClick={handleToggle} style={{ cursor: 'pointer', color: 'inherit' }}>
      ...
      <ImageList variant="masonry" cols={getCols()} gap={16}>
        ...
        {itemData.map((item) => (
          <ImageListItem
            ...
            rows={item.rows || 1}
            sx={{
              borderRadius: 2, // Consistent border radius for all devices
              overflow: 'hidden', // Ensure child elements respect the border radius
              position: 'relative', // Position to ensure overlay effects
              mb: 4, // Added space between items
            }}
          >
            <img
...
const itemData = [
  {
    ...
    description:
      'Data scientists analyze complex data sets to extract insights and make data-driven decisions. They use statistical techniques, machine learning, and data visualization to help organizations understand trends and patterns in their data.',
  },
  {
    ...
    description:
      'Digital marketing specialists design and implement online marketing strategies to promote products and services. They work with social media, search engine optimization (SEO), content marketing, and pay-per-click (PPC) advertising to engage audiences and drive conversions.',
  },
  {
    ...
    description:
      'Cybersecurity analysts protect an organization’s computer systems and networks from cyber threats. They monitor networks for security breaches, develop security policies, and implement measures to safeguard sensitive data.',
  },
  {
    ...
    description:
      'UX/UI designers create user-friendly and visually appealing interfaces for digital products. They focus on enhancing user experience by designing intuitive layouts and interactions, ensuring that products are both functional and aesthetically pleasing.',
    cols: 2,
  },
  {
    ...
    description:
      'Environmental scientists study the natural environment and develop solutions to environmental problems. They conduct research on issues like pollution, conservation, and climate change, and work with governments and organizations to implement sustainable practices.',
    cols: 2,
  },
  {
    ...
    description:
      'Software engineers design, develop, and maintain software applications. They use programming languages and frameworks to build software solutions for various industries, from mobile apps to enterprise systems.',
    rows: 2,
    cols: 2,
    featured: true,
  },
  {
    ...
    description:
      'Healthcare administrators manage the operations of healthcare facilities, such as hospitals and clinics. They oversee budgeting, staffing, and regulatory compliance to ensure efficient and effective delivery of healthcare services.',
  },
  {
    ...
    description:
      'Graphic designers create visual content for various media, including print, digital, and social platforms. They use typography, color, and imagery to communicate ideas and brand messages effectively.',
  },
  {
    ...
    description:
      'Mechanical engineers design and develop mechanical systems and devices. They work on projects ranging from small components to large machinery, applying principles of physics and material science to create efficient and reliable products.',
    rows: 2,
    cols: 2,
  },
  {
    ...
    description:
      'Human resources managers oversee the recruitment, training, and development of an organization’s workforce. They manage employee relations, compensation, benefits, and compliance with labor laws.',
  },
  {
    ...
    title: 'Urban Planner',
    description:
      'Urban planners develop plans and programs for land use in urban areas. They work to create sustainable and functional communities by balancing economic, social, and environmental factors in their planning efforts.',
  },
  {
    ...
    description:
      'Biomedical engineers design and develop medical devices and equipment. They work at the intersection of engineering and healthcare to create technologies that improve patient care and treatment outcomes.',
    cols: 2,
  },
];
